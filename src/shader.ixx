...
export const GLuint buildShaderProgram(const std::unordered_map<std::string, GLenum>& sourceFiles) {
...
export void setUniformToProgram(const GLuint& shaderProgram, const std::string& name,
                                const glm::mat4& mat) {
