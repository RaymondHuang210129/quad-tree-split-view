...
const GLuint& CeilingVaoProvider::vao() const {
...
CeilingComponent::CeilingComponent(const glm::vec3& position) {
...
void CeilingComponent::render(const glm::mat4& view, const glm::mat4& proj,
